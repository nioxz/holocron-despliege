    ...
    <form wire:submit.prevent="register" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input wire:model="name" type="text" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required autofocus />
                    <x-input-error :messages="$errors->get('name')" class="mt-1" />
                </div>

                <div>
                    <label class="block font-medium text-sm text-gray-300 mb-1">Apellidos</label>
                    <input wire:model="surname" type="text" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required />
                ...
                <div>
                    ...
                    <input wire:model="dni" type="text" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required />
                ...
                <div>
                    ...
                    <input wire:model="birthdate" type="date" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required />
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input wire:model="job_title" type="text" placeholder="Ej: Operador de Maquinaria" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required />
                ...
                <div>
                    ...
                    <input wire:model="email" type="email" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required />
                    <x-input-error :messages="$errors->get('email')" class="mt-1" />
                </div>

                <div>
                    <label class="block font-medium text-sm text-gray-300 mb-1">Contraseña</label>
                    <input wire:model="password" type="password" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required />
                    <x-input-error :messages="$errors->get('password')" class="mt-1" />
                </div>

                <div>
                    <label class="block font-medium text-sm text-gray-300 mb-1">Confirmar Contraseña</label>
                    <input wire:model="password_confirmation" type="password" class="w-full bg-gray-700 border-gray-600 rounded-lg text-white" required />
        ...
        <div class="flex flex-col md:flex-row items-center justify-between pt-6 border-t border-gray-700">
            <label class="inline-flex items-start cursor-pointer mb-4 md:mb-0 max-w-md">
                <input wire:model="terms" type="checkbox" class="mt-1 w-5 h-5 rounded bg-gray-700 border-gray-500 text-blue-600">
            ...
            <div class="flex items-center gap-4">
                <a class="underline text-sm text-gray-400 hover:text-white transition" href="{{ route('login') }}">
                    ¿Ya tienes cuenta?
                </a>
